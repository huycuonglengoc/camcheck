        ...
        {status !== "active" && (
          <div className={styles.placeholder}>
            ...
            {(status === "denied" || status === "error" || status === "no-device") && (
              <div className={styles.placeholderContent}>
                <div className={styles.placeholderIcon} style={{ color: "var(--error)" }}>
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
          ...
          {status === "active" && (
            <div className={styles.sliders}>
              <div className={styles.sliderGroup}>
                <label htmlFor="brightness-slider">☀️ Brightness: {brightness}%</label>
                <input
          ...
          <div className={`${styles.stats} animate-fade-in`}>
            <div className={styles.statCard}>
              ...
              <div>
                ...
                <div className={styles.statValue} title={deviceInfo.label}>
            ...
            <div className={styles.statCard}>
              ...
              <div>
                ...
                <div className={styles.statValue}>{deviceInfo.resolution}</div>
              </div>
            </div>
            <div className={styles.statCard}>
              <div className={styles.statIcon}>⚡</div>
